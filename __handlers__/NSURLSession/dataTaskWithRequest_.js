...
{
  /**
   * Called synchronously when about to call -[NSURLSession dataTaskWithRequest:].
   *
  ...
  /**
   * Called synchronously when about to return from -[NSURLSession dataTaskWithRequest:].
   *
